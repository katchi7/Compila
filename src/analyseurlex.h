...
typedef enum{
    ...
    TYPE_BOOL_TOKEN,TYPE_FLOAT_TOKEN,TYPE_CHAR_TOKEN,TYPE_INT_TOKEN,TYPE_STRING_TOKEN,FIN_TOKEN,STR_TOKEN,BOOLEAN_TRUE_TOKEN,BOOLEAN_FALSE_TOKEN,ERREUR_TOKEN
}CODES_LEX;
typedef struct {
    CODES_LEX Code;
    char NOM[20];
